...
module.exports = function profileImageUrlUpload () {
  return (req: Request, res: Response, next: NextFunction) => {
    if (req.body.imageUrl !== undefined) {
      ...
      const sas = "BlobEndpoint=https://robcddemostorage.blob.core.windows.net/;QueueEndpoint=https://robcddemostorage.queue.core.windows.net/;FileEndpoint=https://robcddemostorage.file.core.windows.net/;TableEndpoint=https://robcddemostorage.table.core.windows.net/;SharedAccessSignature=sv=2021-06-08&ss=b&srt=c&sp=ry&se=2024-09-13T01:50:31Z&st=2022-09-12T17:50:31Z&spr=https&sig=uev9uPPOASMmIy1lZH8ANZ3%2F4zal3Wso4Kj8%2Be2Qfi0%3D"; 
      //https://docs.github.com/en/code-security/secret-scanning/secret-scanning-patterns#supported-secrets-for-partner-patterns
